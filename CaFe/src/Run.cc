...
void Run::EndOfRun() {
    ...
    //    //run condition
    //    if (fdebug) std::cout << "run condition" << std::endl;
    ...
    //    if (fdebug) std::cout << "frequency of processes" << std::endl;
    ...
    if (fdebug) std::cout << "total track length of incident neutron" << std::endl;
    ...
    //particles count
    if (fdebug) std::cout << "particles count" << std::endl;
